...
export function getMovies(navigation) {
  ...
  useEffect(() => {
    fetch("https://streaming.arthurcargnelli.eu/Playback/BitrateTest?Size=500000&api_key=535f213cb7bc4142838e5390270493cb")
    fetch("https://streaming.arthurcargnelli.eu/Playback/BitrateTest?Size=1000000&api_key=535f213cb7bc4142838e5390270493cb")
    fetch("https://streaming.arthurcargnelli.eu/Playback/BitrateTest?Size=3000000&api_key=535f213cb7bc4142838e5390270493cb")
    fetch("https://streaming.arthurcargnelli.eu/Users/bbfb33db95d74eef8761c63b9dd929cb/Items?SortBy=SortName%2CProductionYear&SortOrder=Ascending&IncludeItemTypes=Movie&Recursive=true&Fields=PrimaryImageAspectRatio%2CMediaSourceCount%2CBasicSyncInfo&ImageTypeLimit=1&EnableImageTypes=Primary%2CBackdrop%2CBanner%2CThumb&StartIndex=0&ParentId=db4c1708cbb5dd1676284a40f2950aba&Limit=100&api_key=535f213cb7bc4142838e5390270493cb")
    .then( response => {
